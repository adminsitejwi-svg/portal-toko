    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h5 class="font-medium text-lg">Media Koneksi</h5>
                <a href="<?= site_url('MediaKoneksi/create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition">
                    ...
                    <div class="table-scroll">
                        ...
                        <div id="editModal"
                            ...
                            <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6">
                                ...
                                <form action="<?= site_url('MediaKoneksi/update') ?>" method="POST">
        ...
        $(document).ready(function() {
            ...
            const table = $('#mediaKoneksiTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: "Data Media Koneksi belum tersedia",
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href =
                        "<?= site_url('MediaKoneksi/delete/') ?>" + id;
                }
