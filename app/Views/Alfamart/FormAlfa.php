...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
        ...
        <div class="p-6">
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    <div>
                        <h2>Form Pendaftaran Toko Alfamart</h2>
                    </div>
                </div>

                <div class="form-card">
                    <form action="<?= site_url('Alfamart/save') ?>" method="POST" id="FormAlfa" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_alfamart" placeholder="Cth: Alfamart Sudirman" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_alfamart" placeholder="Jl. ..." required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="vendor_id" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                                    <option value="">— Pilih —</option class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                        ...
                        <div class="action-bar">
                            ...
                            <button type="button" class="btn-back" onclick="window.location.href='<?= site_url('Alfamart') ?>'">Kembali</button>
                        </div>
                    </form>
                </div>
            </div>
   ...
   ════════════════════════════════════════════════ */
        ...
        document.getElementById('FormAlfa').addEventListener('submit', function(e) {
