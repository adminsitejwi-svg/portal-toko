            ...
            <ul class="px-0">
                ...
                <li class="hasmenu">
                    ...
                    <ul class="submenu bg-black/20">
                        ...
                        <li><a href="#" class="block pl-[52px] pr-6 py-2 text-[13px] hover:text-white">ALFAMART</a></li>
                    </ul>
                </li>
                <li class="hasmenu">
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h5 class="font-medium text-lg">Toko Alfamart</h5>

                <a href="<?= site_url('Alfamart/create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition">
                ...
                <div class="card-body">
                    ...
                    <div class="table-scroll">
                        <table id="mediaKoneksiTable" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                <?php if (!empty($alfamart)) : ?>
                                    <?php $no = 1; ?>

                                    <?php foreach ($alfamart as $row) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>

                                            <td><?= esc($row['kode_toko']); ?></td>

                                            <td><?= esc($row['nama_alfamart']); ?></td>

                                            <td><?= esc($row['alamat_alfamart']); ?></td>
                                            ...
                                            <td>
                                                <a href="<?= site_url('Alfamart/edit/' . $row['id']) ?>"
        ...
        $(document).ready(function() {
            ...
            const table = $('#mediaKoneksiTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: "Data Toko Alfamart belum tersedia",
