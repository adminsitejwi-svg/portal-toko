...
<head>
    ...
    <style>
        ...
        .dark #jenisPerangkatTable thead th {
            background: #2b3543;
            color: #9fb0c2;
            border-color: #37404c;
        }

        #jenisPerangkatTable tbody td {
            padding: 16px;
            font-size: 14px;
            color: #3b4754;
        ...
        .dark #jenisPerangkatTable tbody td {
            color: #bfc8d6;
            border-color: #37404c;
        }

        #jenisPerangkatTable tbody tr:hover {
            background: #fafbfc;
        }

        .dark #jenisPerangkatTable tbody tr:hover {
            background: rgba(255, 255, 255, .03);
        }

        #jenisPerangkatTable tbody td.col-bold {
            font-weight: 600;
            color: #2b3540;
        }

        .dark #jenisPerangkatTable tbody td.col-bold {
            color: #e7eaf0;
        }
...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
            ...
            <ul class="px-0">
                ...
                <li class="hasmenu">
                    ...
                    <ul class="submenu bg-black/20">
                        ...
                        <li><a href="#" class="block pl-[52px] pr-6 py-2 text-[13px] hover:text-white">Type Perangkat</a></li>
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h5 class="font-medium text-lg">Type Perangkat</h5>

                <a href="<?= site_url('TypePerangkat/create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-scroll">
                        <table id="jenisPerangkatTable" class="display nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                            ...
                            <tbody>
                                <?php if (!empty($MD_type_perangkat)) : ?>
                                    <?php $no = 1; ?>
                                    <?php foreach ($MD_type_perangkat as $row) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= esc($row['jenis_perangkat']); ?></td>
                                            <td><?= esc($row['merk_perangkat']); ?></td>
                                            <td><?= esc($row['type_perangkat']); ?></td>
                                            <td>
                                                <?php if ($row['status'] == 0) : ?>
                                            ...
                                            <td>
                                                <button
                                                    ...
                                                    onclick="openEditModal(
                                                        '<?= $row['id'] ?>',
                                                        '<?= esc($row['jenis_perangkat_id']) ?>',
                                                        '<?= esc($row['merek_perangkat_id']) ?>',
                        ...
                        <div id="editModal"
                            ...
                            <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6">
                                ...
                                <form action="<?= site_url('TypePerangkat/update') ?>" method="POST">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <select id="edit_jenis_perangkat_id"
                                                name="jenis_perangkat_id"
                                                class="w-full border rounded-lg p-3">

                                                <option value="">Pilih Merk</option>

                                                <?php if (!empty($md_jenis_perangkat)) : ?>
                                                    <?php foreach ($md_jenis_perangkat as $p) : ?>
                                                        <option value="<?= $p['id']; ?>">
                                                            <?= esc($p['jenis_perangkat']); ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                        ...
                                        <div class="md:col-span-2">
                                            ...
                                            <select id="edit_merk_perangkat_id"
                                                name="merk_perangkat_id"
                                                class="w-full border rounded-lg p-3">

                                                <option value="">Pilih Merk</option>

                                                <?php if (!empty($md_merek_perangkat)) : ?>
                                                    <?php foreach ($md_merek_perangkat as $p) : ?>
                                                        <option value="<?= $p['id']; ?>">
                                                            <?= esc($p['merk_perangkat']); ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#jenisPerangkatTable').DataTable({
                pageLength: 10,
                lengthMenu: [
                    [10, 15, 25, 50, -1],
                    [10, 15, 25, 50, "Semua"]
                ...
                language: {
                    ...
                    emptyTable: "Data Type Perangkat belum tersedia",
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href =
                        "<?= site_url('TypePerangkat/delete/') ?>" + id;
                }
    ...
    <script>
        function openEditModal(id, jenis_perangkat_id, merk_perangkat_id, type_perangkat, status, keterangan) {
            document.getElementById('edit_id').value = id;
            document.getElementById('edit_jenis_perangkat_id').value = jenis_perangkat_id;
            document.getElementById('edit_merk_perangkat_id').value = merk_perangkat_id;
            document.getElementById('edit_type_perangkat').value = type_perangkat;
