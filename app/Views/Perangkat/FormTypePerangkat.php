...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            <div class="form-container">
                <h2>Form Pendaftaran Type Perangkat</h2>
                <form action="<?= site_url('TypePerangkat/save') ?>" method="POST" id="FormJanis_Prgkt">
                    <?= csrf_field() ?>
                    <div class="form-group mt-5">
                        <label>Jenis Perangkat<span style="color:red">*</span></label>
                        <select name="jenis_perangkat_id" class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none" required>
                    ...
                    <div class="form-group mt-5">
                        <label>Merek Perangkat<span style="color:red">*</span></label>
                        <select name="merk_perangkat_id" class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none" required>
                    ...
                    <div class="form-group">
                        <label>Type Perangkat<span style="color:red">*</span></label>
                        <input type="text"
                            name="type_perangkat"
                            id="type_perangkat"
                            required>
    ...
    <script>
        document.getElementById('FormJanis_Prgkt').addEventListener('submit', function(e) {
            const jenis_perangkat = document.getElementById('jenis_perangkat').value.trim();
