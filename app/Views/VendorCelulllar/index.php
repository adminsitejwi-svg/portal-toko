	...
	<body class="text-[#37474f] dark:text-[#bfc8d6]">
	    ...
	    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
	        ...
	        <div class="p-6">
	            ...
	            <div class="flex items-center justify-between mb-6">
	                <h5 class="font-medium text-lg">Vendor Celullar</h5>

	                <a href="<?= site_url('VendorCelulllar/create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition">
	                ...
	                <div class="card-body">
	                    ...
	                    <div class="table-scroll">
	                        <table id="mediaKoneksiTable" class="display nowrap" style="width:100%">
	                            ...
	                            <tbody>
	                                <?php if (!empty($MD_VendorCelulllar)) : ?>
	                                    <?php $no = 1; ?>
	                                    <?php foreach ($MD_VendorCelulllar as $row) : ?>
	                                        <tr>
	                                            <td><?= $no++; ?></td>
	                        ...
	                        <div id="editModal"
	                            ...
	                            <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6">
	                                ...
	                                <form action="<?= site_url('VendorCelulllar/update') ?>" method="POST">
	        ...
	        $(document).ready(function() {
	            ...
	            const table = $('#mediaKoneksiTable').DataTable({
	                ...
	                language: {
	                    ...
	                    emptyTable: "Data vendor belum tersedia",
	            ...
	            Swal.fire({
	                ...
	                if (result.isConfirmed) {
	                    window.location.href =
	                        "<?= site_url('VendorCelulllar/delete/') ?>" + id;
	                }
	    ...
	    <script>
	        function openEditModal(id, nama_vendor, alamat_vendor, status, keterangan, ) {

	            document.getElementById('edit_id').value = id;
	            document.getElementById('edit_nama_vendor').value = nama_vendor;
	            document.getElementById('edit_alamat_vendor').value = alamat_vendor;
