            ...
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <div class="subtitle">ID: <?= $midi['id'] ?> • <?= esc($midi['nama_lawson']) ?></div>
                    </div>
                </div>

                <div class="form-card">
                    <form action="<?= site_url('Lawson/update') ?>" method="POST" id="FormEditMidi" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_lawson"
                                    value="<?= esc($midi['nama_lawson']) ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_lawson"
                                    value="<?= esc($midi['alamat_lawson']) ?>" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="action-bar">
                            ...
                            <button type="button" class="btn-back"
                                onclick="window.location.href='<?= site_url('Lawson') ?>'">
                                Kembali
                            </button>
                        </div>
                    </form>
