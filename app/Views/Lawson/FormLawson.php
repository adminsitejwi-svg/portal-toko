...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            <div class="page-wrapper">
                ...
                <div class="form-card">
                    <form action="<?= site_url('Lawson/save') ?>" method="POST" id="FormLawson" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_lawson" placeholder="Cth: Lawson Sudirman" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_lawson" placeholder="Jl. ..." required>
                            </div>
                            <div class="form-group">
   ...
   ════════════════════════════════════════════════ */
        ...
        document.getElementById('FormLawson').addEventListener('submit', function(e) {
