    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            <div class="form-container">
                <h2>Form Pendaftaran Layanan Jwi Form</h2>
                <form action="<?= site_url('LayananJwi/save') ?>" method="POST" id="dcForm">
                    ...
                    <div class="d-flex"> <button type="submit"> Simpan </button> <button type="button" class="btn-back" onclick="window.location.href='<?= site_url('LayananJwi') ?>'"> Kembali </button> </div>
                </form>
            </div>
        </div>
    </div>
