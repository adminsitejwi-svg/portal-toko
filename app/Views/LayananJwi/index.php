...
<body class="text-[#37474f] dark:text-[#bfc8d6]">
            ...
            <ul class="px-0">
                ...
                <li class="hasmenu">
                    ...
                    <ul class="submenu bg-black/20">
                        ...
                        <li><a href="#" class="block pl-[52px] pr-6 py-2 text-[13px] hover:text-white">Layanan jwi group</a></li>
    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h5 class="font-medium text-lg">Layanan JWI Group</h5>
                <a href="<?= site_url('LayananJwi/create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition">
                ...
                <div class="card-body">
                    ...
                    <div class="table-scroll">
                        <table id="layananTable" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                <?php if (!empty($MD_layanan_jwi_group)) : ?>
                                    <?php $no = 1; ?>
                                    <?php foreach ($MD_layanan_jwi_group as $row) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                        ...
                        <div id="editModal"
                            ...
                            <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6">
                                ...
                                <form action="<?= site_url('LayananJwi/update') ?>" method="POST">
        ...
        $(document).ready(function() {
            ...
            const table = $('#layananTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: "Data layanan JWI Group belum tersedia",
    ...
    <script>
        function openEditModal(id, nama_layanan, status, keterangan, ) {
