    ...
    <div id="container" class="pc-container ml-sidebar min-h-screen transition-[margin] duration-200">
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <h5 class="font-medium text-lg">Kuota Simcard</h5>
                <a href="<?= site_url('QuotaSIMCARD/create') ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition">
                        ...
                        <div id="editModal" class="fixed inset-0 bg-black/50 hidden z-50 flex items-center justify-center">
                            <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
                                ...
                                <div class="flex justify-between items-center mb-6">
                                    <h3 class="text-xl font-bold">Edit Data Kuota Simcard</h3>
                                    <button onclick="closeEditModal()"><i class="ti ti-x text-2xl"></i></button>
                                </div>

                                <form action="<?= site_url('QuotaSIMCARD/update') ?>" method="POST">
                                    <?= csrf_field() ?>
        ...
        $(document).ready(function() {
            ...
            const table = $('#mediaKoneksiTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: "Data Kuota Simcard belum tersedia",
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href =
                        "<?= site_url('QuotaSIMCARD/delete/') ?>" + id;
                }
