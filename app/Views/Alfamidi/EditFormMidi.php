        ...
        <div class="p-6">
            <div class="page-wrapper">
                ...
                <div class="page-header">
                    <div>
                        <h2>Edit Data Toko Midi</h2>
                        <div class="subtitle">ID: <?= $midi['id'] ?> • <?= esc($midi['nama_alfamidi']) ?></div>
                    </div>
                </div>

                <div class="form-card">
                    <form action="<?= site_url('Alfamidi/update') ?>" method="POST" id="FormEditMidi" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="grid-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_alfamidi"
                                    value="<?= esc($midi['nama_alfamidi']) ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat_alfamidi"
                                    value="<?= esc($midi['alamat_alfamidi']) ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="merk_perangkat_id" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                                    ...
                                    <?php foreach ($perangkat as $row): ?>
                                        <option value="<?= $row['id'] ?>"
                                            <?= $midi['merk_perangkat_id'] == $row['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="grid-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type_perangkat" required class="w-full min-h-[46px] px-4 py-3 text-sm border border-[#e3e8ee] rounded-lg text-[#3b4754] bg-white focus:border-primary-500 outline-none">
                                    <option value="">— Pilih —</option>
                                    <?php foreach ($type_perangkat as $row): ?>
                                        <option value="<?= $row['id'] ?>"
                                            <?= $midi['type_perangkat'] == $row['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="action-bar">
                            ...
                            <button type="button" class="btn-back"
                                onclick="window.location.href='<?= site_url('Alfamidi') ?>'">
                                Kembali
                            </button>
                        </div>
                    </form>
